...
class WriteDiaryViewController: UIViewController {
    ...
    var diaryEditorMode: DiaryEditroMode = .new
    ...
    @objc private func datePickerValueDidChange(_ datePicker: UIDatePicker){
        ...
        formaater.dateFormat = "yyyy 년 MM 월 dd일(EEEEE)"
        formaater.locale = Locale(identifier: "ko_KR")
        self.diaryDate = datePicker.date
        self.dateTextField.text = formaater.string(from: datePicker.date)
    ...
    @objc private func validateInputField(){
